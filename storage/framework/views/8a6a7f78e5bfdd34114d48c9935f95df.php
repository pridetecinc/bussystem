<?php $__env->startSection('title', '新規予約分類登録'); ?>
        ...
        <div class="col-md-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="<?php echo e(route('masters.reservation-categories.index')); ?>">予約分類マスター</a></li>
            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('masters.reservation-categories.store')); ?>" method="POST" id="categoryForm">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" id="category_code" name="category_code" value="<?php echo e(old('category_code')); ?>" required maxlength="20" placeholder="例: CAT001">
...
unset($__errorArgs, $__bag); ?>" id="category_name" name="category_name" value="<?php echo e(old('category_name')); ?>" required maxlength="100" placeholder="例: 一般予約">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="d-flex justify-content-between mt-4">
                            <div>
                                ...
                                <a href="<?php echo e(route('masters.reservation-categories.index')); ?>" class="btn btn-secondary">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /www/wwwroot/default/resources/views/masters/reservation-categories/create.blade.php ENDPATH**/ ?>