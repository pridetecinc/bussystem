<?php $__env->startSection('title', '車両新規登録'); ?>
        ...
        <div class="col-md-12">
            ...
            <div class="card shadow-sm">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0">
                        <i class="bi bi-car-front"></i> 車両新規登録
                    </h5>
                </div>
                
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('masters.vehicles.store')); ?>" id="vehicleForm">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                       value="<?php echo e(old('vehicle_code')); ?>" required maxlength="20" placeholder="例: V001">
...
unset($__errorArgs, $__bag); ?>"
                                       value="<?php echo e(old('registration_number')); ?>" required maxlength="20" 
...
unset($__errorArgs, $__bag); ?>"
                                           value="<?php echo e(old('seating_capacity', 4)); ?>" required min="1" max="100">
...
unset($__errorArgs, $__bag); ?>" required>
                                    <option value="">選択してください</option>
                                    <option value="company" <?php echo e(old('ownership_type') == 'company' ? 'selected' : ''); ?>>会社所有</option>
                                    <option value="rental" <?php echo e(old('ownership_type') == 'rental' ? 'selected' : ''); ?>>レンタル</option>
                                    <option value="personal" <?php echo e(old('ownership_type') == 'personal' ? 'selected' : ''); ?>>個人所有</option>
                                </select>
...
unset($__errorArgs, $__bag); ?>"
                                       value="<?php echo e(old('inspection_expiration_date')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                                              ...
                                              rows="3" maxlength="500"><?php echo e(old('remarks')); ?></textarea>
                                ...
                                <div class="mt-2">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="is_active" id="is_active_true" 
                                               value="1" <?php echo e(old('is_active', 1) == 1 ? 'checked' : ''); ?>>
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="is_active" id="is_active_false" 
                                               value="0" <?php echo e(old('is_active') == '0' ? 'checked' : ''); ?>>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const oldModelId = <?php echo e(old('vehicle_model_id', 'null')); ?>;
    ...
    function updateModelDropdown() {
        ...
        if (oldModelId) {
            const modelExists = models.some(model => model.id == oldModelId);
            if (modelExists) {
                vehicleModelSelect.value = oldModelId;
            }
        }
    }
    
    vehicleTypeSelect.addEventListener('change', updateModelDropdown);
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /www/wwwroot/default/resources/views/masters/vehicles/create.blade.php ENDPATH**/ ?>