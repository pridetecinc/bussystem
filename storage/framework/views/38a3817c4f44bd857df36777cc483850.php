<?php $__env->startSection('title', 'ガイド新規登録'); ?>
        ...
        <div class="col-md-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="<?php echo e(route('masters.guides.index')); ?>">ガイド管理</a></li>
            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('masters.guides.store')); ?>" method="POST" id="guideForm">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control <?php $__errorArgs = ['guide_code'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                       ...
                                       value="<?php echo e(old('guide_code')); ?>" 
                                       required maxlength="20" placeholder="例: GD001">
                                <?php $__errorArgs = ['guide_code'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                    ...
                                    <option value="">選択してください</option>
                                    <option value="自社" <?php echo e(old('employment_type') == '自社' ? 'selected' : ''); ?>>自社</option>
                                    <option value="契約" <?php echo e(old('employment_type') == '契約' ? 'selected' : ''); ?>>契約</option>
                                    <option value="業務委託" <?php echo e(old('employment_type') == '業務委託' ? 'selected' : ''); ?>>業務委託</option>
                                </select>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="d-flex justify-content-between mt-4">
                            <div>
                                ...
                                <a href="<?php echo e(route('masters.guides.index')); ?>" class="btn btn-secondary">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /www/wwwroot/default/resources/views/masters/guides/create.blade.php ENDPATH**/ ?>