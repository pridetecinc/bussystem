<?php $__env->startSection('title', '行程編集'); ?>
...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="<?php echo e(route('masters.itineraries.update', $itinerary)); ?>" method="POST" id="itineraryForm">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                               ...
                                               value="<?php echo e(old('itinerary_code', $itinerary->itinerary_code)); ?>" 
...
unset($__errorArgs, $__bag); ?>" 
                                               ...
                                               value="<?php echo e(old('itinerary_name', $itinerary->itinerary_name)); ?>" 
...
unset($__errorArgs, $__bag); ?>" 
                                               ...
                                               value="<?php echo e(old('category', $itinerary->category)); ?>"
...
unset($__errorArgs, $__bag); ?>" 
                                                  ...
                                                  maxlength="500" placeholder="例: 行程の詳細説明、注意事項など"><?php echo e(old('remarks', $itinerary->remarks)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <tbody id="detailsBody">
                                    ...
                                    <?php if(count($oldDetails) > 0): ?>
                                        ...
                                        <?php
                                            ...
                                            $orderNumber = $index + 1;
                                        ?>
                                        <tr data-index="<?php echo e($index); ?>" data-id="<?php echo e($oldDetail['id'] ?? ''); ?>">
                                            ...
                                            <td class="text-center align-middle">
                                                ...
                                                <input type="hidden" name="details[<?php echo e($index); ?>][id]" value="<?php echo e($oldDetail['id'] ?? ''); ?>">
                                        ...
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php else: ?>
                                        <?php $__currentLoopData = $itinerary->details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr data-index="<?php echo e($index); ?>" data-id="<?php echo e($detail->id); ?>">
                                            <td class="text-center align-middle display-order"><?php echo e($index + 1); ?></td>
                                            <td>
                                                <input type="time" class="form-control form-control-sm arrival-time" 
                                                       name="details[<?php echo e($index); ?>][arrival_time]" 
                                                       value="<?php echo e($detail->arrival_time ? $detail->arrival_time->format('H:i') : ''); ?>">
                                            </td>
                                            <td>
                                                <input type="time" class="form-control form-control-sm departure-time" 
                                                       name="details[<?php echo e($index); ?>][departure_time]" 
                                                       value="<?php echo e($detail->departure_time ? $detail->departure_time->format('H:i') : ''); ?>">
                                            </td>
                                            <td>
                                                <textarea class="form-control form-control-sm description" 
                                                          name="details[<?php echo e($index); ?>][description]" 
                                                          rows="2" maxlength="500" 
                                                          placeholder="行程の説明"><?php echo e($detail->description); ?></textarea>
                                            </td>
                                            <td>
                                                <input type="text" class="form-control form-control-sm remark" 
                                                       name="details[<?php echo e($index); ?>][remark]" 
                                                       value="<?php echo e($detail->remark); ?>" 
                                                       maxlength="255" placeholder="備考">
                                            </td>
                                            <td class="text-center align-middle">
                                                <div class="d-flex justify-content-center gap-1">
                                                ...
                                                <input type="hidden" name="details[<?php echo e($index); ?>][display_order]" value="<?php echo e($index + 1); ?>">
                                            </td>
                                        </tr>
                                        <?php $detailIndex = $index + 1; ?>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <form id="deleteForm" action="<?php echo e(route('masters.itineraries.destroy', $itinerary)); ?>" method="POST" class="d-none">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /www/wwwroot/default/resources/views/masters/itineraries/edit.blade.php ENDPATH**/ ?>