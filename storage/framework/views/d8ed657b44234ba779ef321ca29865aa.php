<?php $__env->startSection('title', '新規Bank登録'); ?>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('masters.banks.store')); ?>" method="POST" id="bankForm">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                      ...
                                      placeholder="例: 支店名: 東京支店&#13;&#10;口座番号: 1234567&#13;&#10;口座種別: 普通預金"><?php echo e(old('bank_info')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" 
                                    ...
                                    <option value="1" <?php echo e(old('is_active', '1') == '1' ? 'selected' : ''); ?>>有効</option>
                                    <option value="0" <?php echo e(old('is_active') == '0' ? 'selected' : ''); ?>>無効</option>
                                </select>
...
unset($__errorArgs, $__bag); ?>" 
                                          ...
                                          placeholder="例: 給与振込専用口座"><?php echo e(old('remarks')); ?></textarea>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /www/wwwroot/default/resources/views/masters/banks/create.blade.php ENDPATH**/ ?>