<?php $__env->startSection('title', '新規スタッフ登録'); ?>
        ...
        <div class="col-md-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="<?php echo e(route('masters.staffs.index')); ?>">スタッフ管理</a></li>
            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('masters.staffs.store')); ?>" method="POST" id="staffForm">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" id="branch_id" name="branch_id" required>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control <?php $__errorArgs = ['staff_code'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="staff_code" name="staff_code" value="<?php echo e(old('staff_code')); ?>" required maxlength="20" placeholder="例: ST001">
...
unset($__errorArgs, $__bag); ?>" id="name" name="name" value="<?php echo e(old('name')); ?>" required maxlength="100" placeholder="例: 山田 太郎">
...
unset($__errorArgs, $__bag); ?>" id="display_order" name="display_order" value="<?php echo e(old('display_order')); ?>" min="0" placeholder="例: 10">
...
unset($__errorArgs, $__bag); ?>" id="email" name="email" value="<?php echo e(old('email')); ?>" maxlength="100" placeholder="例: yamada@example.com">
...
unset($__errorArgs, $__bag); ?>" id="login_id" name="login_id" value="<?php echo e(old('login_id')); ?>" required maxlength="50" placeholder="例: yamada">
...
unset($__errorArgs, $__bag); ?>" id="role" name="role" required>
                                    <option value="">選択してください</option>
                                    <option value="admin" <?php echo e(old('role') == 'admin' ? 'selected' : ''); ?>>管理者</option>
                                    <option value="operations_manager" <?php echo e(old('role') == 'operations_manager' ? 'selected' : ''); ?>>運行管理者</option>
                                    <option value="coordinator" <?php echo e(old('role') == 'coordinator' ? 'selected' : ''); ?>>運行手配</option>
                                    <option value="manager" <?php echo e(old('role') == 'manager' ? 'selected' : ''); ?>>経理</option>
                                    <option value="driver" <?php echo e(old('role') == 'driver' ? 'selected' : ''); ?>>運転手</option>
                                    <!--<option value="staff" <?php echo e(old('role') == 'staff' ? 'selected' : ''); ?>>一般スタッフ</option>-->
                                </select>
...
unset($__errorArgs, $__bag); ?>" id="password" name="password" required minlength="8">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="d-flex justify-content-between mt-4">
                            <div>
                                ...
                                <a href="<?php echo e(route('masters.staffs.index')); ?>" class="btn btn-secondary">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /www/wwwroot/default/resources/views/masters/staffs/create.blade.php ENDPATH**/ ?>