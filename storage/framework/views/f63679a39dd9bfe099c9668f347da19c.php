<?php $__env->startSection('title', '新規予約作成'); ?>

<?php $__env->startSection('content'); ?>
<div class="container-fluid">
    <form method="POST" action="<?php echo e(route('masters.group-infos.store')); ?>" id="createForm">
        <?php echo csrf_field(); ?>
        ...
        <div class="m-2">
            <div class="d-flex flex-wrap align-items-center">
                <div class="d-flex align-items-center">
                    ...
                    <input type="checkbox" id="status" class="checkbo mr-5" name="vehicle_selection" <?php echo e(old('vehicle_selection') ? 'checked' : ''); ?>>
                </div>
                
                <div class="d-flex align-items-center mx-3">
                    <label for="yoyaku" class="label-text mr-2">予約状況</label>
                    <select id="yoyaku" class="form-input-small" name="reservation_status">
                        <option value="仮押さえ" style="background-color: #ffff99; color: black;" <?php echo e(old('reservation_status') == '仮押さえ' ? 'selected' : ''); ?>>仮押さえ</option>
                        <option value="見積" style="background-color: #ccffcc; color: black;" <?php echo e(old('reservation_status') == '見積' ? 'selected' : ''); ?>>見積</option>
                        <option value="予約" style="background-color: #ccf5ff; color: black;" <?php echo e(old('reservation_status') == '予約' ? 'selected' : ''); ?> selected>予約</option>
                        <option value="危ない" style="background-color: #ffcccc; color: black;" <?php echo e(old('reservation_status') == '危ない' ? 'selected' : ''); ?>>危ない</option>
                        <option value="確定待ち" style="background-color: #ffd9b3; color: black;" <?php echo e(old('reservation_status') == '確定待ち' ? 'selected' : ''); ?>>確定待ち</option>
                        <option value="確定" style="background-color: #cbb87c; color: black;" <?php echo e(old('reservation_status') == '確定' ? 'selected' : ''); ?>>確定</option>
                        <option value="送信済" style="background-color: #e6e6fa; color: black;" <?php echo e(old('reservation_status') == '送信済' ? 'selected' : ''); ?>>送信済</option>
                        <option value="実績待ち" style="background-color: #e0b0ff; color: black;" <?php echo e(old('reservation_status') == '実績待ち' ? 'selected' : ''); ?>>実績待ち</option>
                        <option value="運行済" style="background-color: #c0c0c0; color: black;" <?php echo e(old('reservation_status') == '運行済' ? 'selected' : ''); ?>>運行済</option>
                        <option value="請求済" style="background-color: #b0e0e6; color: black;" <?php echo e(old('reservation_status') == '請求済' ? 'selected' : ''); ?>>請求済</option>
                        <option value="キャンセル" style="background-color: #d3d3d3; color: black;" <?php echo e(old('reservation_status') == 'キャンセル' ? 'selected' : ''); ?>>キャンセル</option>
                        <option value="稼働不可" style="background-color: #2c2c2c; color: white;" <?php echo e(old('reservation_status') == '稼働不可' ? 'selected' : ''); ?>>稼働不可</option>
                    </select>
                </div>
                ...
                <div class="d-flex align-items-center">
                    ...
                    <select id="category" name="business_category" class="form-input" style="width: 100px;">
                        ...
                        <?php $__currentLoopData = $reservationCategories ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($category->category_name); ?>" 
                                    data-category-id="<?php echo e($category->id); ?>"
                                    data-category-code="<?php echo e($category->category_code); ?>"
                                    data-color-code="<?php echo e($category->color_code); ?>"
                                    <?php echo e(old('business_category') == $category->category_name ? 'selected' : ''); ?>>
        ...
        <div class="card">
            <div class="d-flex align-items-center mb-1 position-relative">
                ...
                <div class="flex-1 position-relative">
                    <input type="text" name="vehicle_name_input" class="form-input search-input" id="vehicle_search" 
                           value="<?php echo e(old('vehicle_name_input')); ?>" placeholder="車両名を入力" autocomplete="off">
                    <input type="hidden" name="vehicle_id" id="vehicle_id" value="<?php echo e(old('vehicle_id')); ?>">
            ...
            <div class="d-flex mb-1">
                ...
                <div class="d-flex align-items-center" style="flex: 1;">
                    ...
                    <span class="mx-2">
                        <input type="time" name="start_time" value="<?php echo e(old('start_time', '08:00')); ?>" class="form-input-small input-width-time" step="60" style="width: 90px;">
                    </span>
                    ...
                    <span class="ms-2">
                        <input type="time" name="end_time" value="<?php echo e(old('end_time', '18:00')); ?>" class="form-input-small input-width-time" step="60" style="width: 90px;">
                    </span>
                </div>
            </div>
            ...
            <div class="d-flex align-items-center mb-1">
                ...
                <div class="input-width-100 mr-4">
                    <input type="text" name="vehicle_number" value="<?php echo e(old('vehicle_number', '1/1')); ?>" class="form-input" id="vehicle_number" placeholder="号車">
                </div>
                ...
                <div class="flex-1 position-relative">
                    <input type="text" name="guide_name_input" class="form-input search-input" id="guide_search" 
                           value="<?php echo e(old('guide_name_input')); ?>" placeholder="ガイド名を入力" autocomplete="off">
                    <input type="hidden" name="guide_id" id="guide_id" value="<?php echo e(old('guide_id')); ?>">
            ...
            <div class="d-flex align-items-center mb-1">
                ...
                <div class="flex-1 position-relative">
                    <input type="text" name="driver_name_input" class="form-input search-input" id="driver_search" 
                           value="<?php echo e(old('driver_name_input')); ?>" placeholder="運転手名を入力" autocomplete="off">
                    <input type="hidden" name="driver_id" id="driver_id" value="<?php echo e(old('driver_id')); ?>">
            ...
            <div id="tabContent" class="tab-content">
                <div class="tab-pane active" id="basic-tab">
                    <div class="d-flex align-items-center mb-1 position-relative">
                        ...
                        <div class="flex-1 position-relative">
                            <input type="text" name="agency_name_input" class="form-input search-input" id="agency_search" 
                                   value="<?php echo e(old('agency_name_input')); ?>" placeholder="代理店名を入力" autocomplete="off">
                            <input type="hidden" name="agency_id" id="agency_id" value="<?php echo e(old('agency_id')); ?>">
                            <input type="hidden" name="agency_code" id="agency_code" value="<?php echo e(old('agency_code')); ?>">
                            <input type="hidden" name="agency_branch" id="agency_branch" value="<?php echo e(old('agency_branch')); ?>">
                            <input type="hidden" name="agency_phone" id="agency_phone" value="<?php echo e(old('agency_phone')); ?>">
                    ...
                    <div class="d-flex align-items-center mb-1">
                        ...
                        <div class="input-width-number mr-4">
                            <input type="number" name="adult_count" id="adult_count" value="<?php echo e(old('adult_count', 0)); ?>" class="form-input" min="0">
                        </div>
                        <div class="label-width text-gray mr-2">小人</div>
                        <div class="input-width-number mr-4">
                            <input type="number" name="child_count" value="<?php echo e(old('child_count', 0)); ?>" class="form-input" min="0">
                        </div>
                        <div class="label-width text-gray mr-2">ガイド</div>
                        <div class="input-width-number mr-4">
                            <input type="number" name="guide_count" value="<?php echo e(old('guide_count', 0)); ?>" class="form-input" min="0">
                        </div>
                        <div class="label-width text-gray mr-2">その他</div>
                        <div class="input-width-number">
                            <input type="number" name="other_count" value="<?php echo e(old('other_count', 0)); ?>" class="form-input" min="0">
                        </div>
                    </div>
                    ...
                    <div class="d-flex align-items-start">
                        ...
                        <div class="flex-1">
                            <textarea name="remarks" rows="5" class="form-input" style="resize: vertical; height: auto;"><?php echo e(old('remarks')); ?></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="tab-pane" id="customer-tab" style="display: none;">
                    <div class="d-flex align-items-center mb-2">
                        ...
                        <div class="flex-1">
                            <input type="text" name="agency_contact_name" value="<?php echo e(old('agency_contact_name')); ?>" class="form-input" id="agency_contact_name">
                        </div>
                    </div>
                    ...
                    <div class="d-flex align-items-center mb-2">
                        ...
                        <div class="flex-1">
                            <input type="text" name="agency_country" value="<?php echo e(old('agency_country')); ?>" class="form-input" id="agency_country">
                        </div>
                    </div>
                    ...
                    <div class="d-flex align-items-center mb-2">
                        ...
                        <div class="flex-1">
                            <input type="text" name="agt_tour_id" class="form-input" value="<?php echo e(old('agt_tour_id')); ?>">
                        </div>
                    </div>
                    ...
                    <div class="d-flex align-items-center mb-2">
                        ...
                        <div class="flex-1">
                            <input type="number" name="luggage_count" value="<?php echo e(old('luggage_count', 0)); ?>" class="form-input" min="0">
                        </div>
                    </div>
                </div>
        ...
        <div class="m-2">
            <div class="d-flex gap-4">
                <div class="d-flex align-items-center">
                    <input type="checkbox" id="ignore_operation" class="checkbox-large" name="ignore_operation" <?php echo e(old('ignore_operation') ? 'checked' : ''); ?>>
                    <label for="ignore_operation" class="label-text">運行無視</label>
                </div>
                <div class="d-flex align-items-center">
                    <input type="checkbox" id="ignore_attendance" class="checkbox-large" name="ignore_attendance" <?php echo e(old('ignore_attendance') ? 'checked' : ''); ?>>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    cancelBtn.addEventListener('click', function() {
        if (isInIframe) {
            ...
            window.location.href = '<?php echo e(route('masters.group-infos.index')); ?>';
        }
    });
    ...
    detailBtn.addEventListener('click', function() {
        ...
        if (id) {
            const editUrl = '<?php echo e(route("masters.group-infos.edit", ":id")); ?>'.replace(':id', id);
            if (isInIframe) {
    ...
    document.getElementById('createForm').addEventListener('submit', function(e) {
        ...
        .then(data => {
            if (data.success) {
                ...
                const editUrl = '<?php echo e(route("masters.group-infos.edit", ":id")); ?>'.replace(':id', data.id);
                window.parent.postMessage({
                    action: 'open-edit',
                    url: editUrl
                }, '*');
                ...
                form.action = '<?php echo e(route("masters.group-infos.update", ":id")); ?>'.replace(':id', data.id);
...
<?php echo $__env->make('layouts.win', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /www/wwwroot/default/resources/views/masters/group-infos/create.blade.php ENDPATH**/ ?>