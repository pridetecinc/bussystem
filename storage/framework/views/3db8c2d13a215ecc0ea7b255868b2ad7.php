<?php $__env->startSection('title', '新規車両種類登録'); ?>
        ...
        <div class="col-md-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="<?php echo e(route('masters.vehicle-types.index')); ?>">車両種類管理</a></li>
            ...
            <form action="<?php echo e(route('masters.vehicle-types.store')); ?>" method="POST" id="vehicleTypeForm">
                <?php echo csrf_field(); ?>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="bg-white" style="width: 50%; padding: 0.5rem;">
                                        <input type="text" class="form-control <?php $__errorArgs = ['type_name'];
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered" id="modelsTable">
                                ...
                                <tbody id="modelsBody">
                                    ...
                                    <?php if(count($oldModels) > 0): ?>
                                        <?php $__currentLoopData = $oldModels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $oldModel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php
                                            $numericIndex = (int)$index;
                                        ?>
                                        <tr data-index="<?php echo e($numericIndex); ?>">
                                            <td class="text-center align-middle display-order"><?php echo e($numericIndex + 1); ?></td>
                                            <td>
                                                <input type="text" class="form-control form-control-sm model-name" 
                                                       name="models[<?php echo e($numericIndex); ?>][model_name]" 
                                                       value="<?php echo e($oldModel['model_name'] ?? ''); ?>"
                                                       maxlength="100" placeholder="例: ハイエース">
                                            </td>
                                            <td>
                                                <input type="text" class="form-control form-control-sm maker" 
                                                       name="models[<?php echo e($numericIndex); ?>][maker]" 
                                                       value="<?php echo e($oldModel['maker'] ?? ''); ?>"
                                                       maxlength="50" placeholder="例: トヨタ">
                                            </td>
                                            <td>
                                                <input type="text" class="form-control form-control-sm remark" 
                                                       name="models[<?php echo e($numericIndex); ?>][remarks]" 
                                                       value="<?php echo e($oldModel['remarks'] ?? ''); ?>" 
                                            ...
                                            <td class="text-center align-middle">
                                                ...
                                                <input type="hidden" name="models[<?php echo e($numericIndex); ?>][id]" value="">
                                                <input type="hidden" name="models[<?php echo e($numericIndex); ?>][display_order]" value="<?php echo e($numericIndex + 1); ?>" class="display-order-input">
                                            </td>
                                        </tr>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php else: ?>
                ...
                <div class="d-flex justify-content-between mb-4">
                    <div>
                        ...
                        <a href="<?php echo e(route('masters.vehicle-types.index')); ?>" class="btn btn-secondary">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /www/wwwroot/default/resources/views/masters/vehicle-types/create.blade.php ENDPATH**/ ?>