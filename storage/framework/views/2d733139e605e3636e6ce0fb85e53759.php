<?php $__env->startSection('title', 'グループ情報一覧'); ?>
...
<div class="container-fluid px-4 py-0">
    ...
    <div class="bg-light p-2 mb-2 rounded" style="background-color: #F3F4F6 !important; border: 1px solid #E5E7EB;">
        <form method="GET" action="<?php echo e(route('masters.group-infos.index')); ?>" class="row g-2">
            <div class="col-auto">
            ...
            <div class="col-auto">
                <a href="<?php echo e(route('masters.group-infos.index')); ?>" class="btn btn-sm btn-outline-secondary px-3" 
    ...
    <div class="table-responsive">
        <table class="table table-sm table-bordered mb-0" style="border-color: #E5E7EB; font-size: 0.875rem;">
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $groupInfos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $groupInfo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                    <td class="text-center px-2 py-1 align-middle">
                        <?php echo e($groupInfos->firstItem() + $index); ?>

                    </td>
                    <td class="text-center px-2 py-1 align-middle">
                        <?php if($groupInfo->start_date): ?>
                            <?php echo e(\Carbon\Carbon::parse($groupInfo->start_date)->format('Y/m/d')); ?>

                            <?php if($groupInfo->start_time): ?>
                                <?php echo e(substr($groupInfo->start_time, 0, 5)); ?>

                            <?php endif; ?>
                        <?php endif; ?>
                    </td>
                    <td class="text-center px-2 py-1 align-middle">
                        <?php if($groupInfo->end_date): ?>
                            <?php echo e(\Carbon\Carbon::parse($groupInfo->end_date)->format('Y/m/d')); ?>

                            <?php if($groupInfo->end_time): ?>
                                <?php echo e(substr($groupInfo->end_time, 0, 5)); ?>

                            <?php endif; ?>
                        <?php endif; ?>
                    </td>
                    <td class="text-center px-2 py-1 align-middle">
                        <?php echo e($groupInfo->agency ?? ''); ?>

                    </td>
                    <td class="text-center px-2 py-1 align-middle">
                        <?php echo e($groupInfo->reservation_status ?? '不明'); ?>
                    ...
                    <td class="text-center px-2 py-1 align-middle">
                        <a href="<?php echo e(route('masters.bus-assignments.show', $groupInfo->id)); ?>" 
                           style="color: #2563eb; text-decoration: none;">
                            詳細
                        </a>
                    </td>
                    <td class="text-center px-2 py-1 align-middle">
                        <?php echo e($groupInfo->vehicle ?? '--'); ?>
                    ...
                    <td class="text-center px-2 py-1 align-middle" style="max-width: 150px;">
                        <span class="text-truncate d-inline-block" style="max-width: 120px;" title="<?php echo e($groupInfo->remarks ?? ''); ?>">
                            <?php echo e($groupInfo->remarks ?? '--'); ?>

                        </span>
                    </td>
                    <td class="text-center px-2 py-1 align-middle">
                        <a href="<?php echo e(route('masters.group-infos.edit', $groupInfo->id)); ?>" 
                           style="color: #2563eb; text-decoration: none; margin-right: 8px;">
                            編集
                        </a>
                        <a href="javascript:void(0);" onclick="confirmDelete('<?php echo e($groupInfo->id); ?>', '<?php echo e($groupInfo->agency ?? 'このグループ'); ?>')" 
    ...
    <div class="d-flex justify-content-between align-items-center mt-2">
        <div style="color: #6b7280; font-size: 0.875rem;">
            全 <?php echo e($groupInfos->total()); ?> 件中 
            <?php echo e($groupInfos->firstItem() ?? 0); ?> - <?php echo e($groupInfos->lastItem() ?? 0); ?> 件表示
        </div>
        <div>
            <?php echo e($groupInfos->withQueryString()->links('pagination::bootstrap-4')); ?>
...
document.getElementById('newGroupBtn').addEventListener('click', function() {
    openIframeModal('<?php echo e(route('masters.group-infos.create')); ?>', '新規グループ作成');
});
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /www/wwwroot/default/resources/views/masters/group-infos/index.blade.php ENDPATH**/ ?>