<?php $__env->startSection('title', 'ユーザー編集'); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                       ...
                                       value="<?php echo e(old('login_id', $user->login_id)); ?>" 
...
unset($__errorArgs, $__bag); ?>" 
                                       ...
                                       value="<?php echo e(old('user_company_name', $user->user_company_name)); ?>" 
...
unset($__errorArgs, $__bag); ?>" 
                                    ...
                                    <option value="basic" <?php echo e(old('user_plan', $user->user_plan) == 'basic' ? 'selected' : ''); ?>>ベーシック</option>
                                    <option value="premium" <?php echo e(old('user_plan', $user->user_plan) == 'premium' ? 'selected' : ''); ?>>プレミアム</option>
                                    <option value="enterprise" <?php echo e(old('user_plan', $user->user_plan) == 'enterprise' ? 'selected' : ''); ?>>エンタープライズ</option>
                                </select>
...
unset($__errorArgs, $__bag); ?>" 
                                       ...
                                       value="<?php echo e(old('user_start_day', $user->user_start_day ? $user->user_start_day->format('Y-m-d') : '')); ?>" required>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /www/wwwroot/default/resources/views/admin/users/edit.blade.php ENDPATH**/ ?>