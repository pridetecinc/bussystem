        ...
        <div class="col-md-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">ガイド編集</li>
                </ol>
            </nav>
            ...
            <div class="card shadow-sm">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0">
                        <i class="bi bi-person-video3"></i> ガイド編集
                    </h5>
                </div>
                
                <div class="card-body">
                    <form action="{{ route('masters.guides.update', $guide) }}" method="POST" id="guideForm">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                                ...
                                <select class="form-select @error('branch_id') is-invalid @enderror" 
                                    ...
                                    @foreach($branches as $branch)
                                        <option value="{{ $branch->id }}" 
                                            {{ old('branch_id', $guide->branch_id) == $branch->id ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('guide_code') is-invalid @enderror" 
                                       ...
                                       value="{{ old('guide_code', $guide->guide_code) }}" 
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('name_kana') is-invalid @enderror" 
                                       ...
                                       value="{{ old('name_kana', $guide->name_kana) }}" 
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('employment_type') is-invalid @enderror" 
                                    ...
                                    <option value="">選択してください</option>
                                    <option value="自社" {{ old('employment_type', $guide->employment_type) == '自社' ? 'selected' : '' }}>自社</option>
                                    <option value="契約" {{ old('employment_type', $guide->employment_type) == '契約' ? 'selected' : '' }}>契約</option>
                                    <option value="業務委託" {{ old('employment_type', $guide->employment_type) == '業務委託' ? 'selected' : '' }}>業務委託</option>
                                </select>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control @error('display_order') is-invalid @enderror" 
                                       ...
                                       value="{{ old('display_order', $guide->display_order) }}" 
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea class="form-control @error('remarks') is-invalid @enderror" 
                                          ...
                                          rows="3" maxlength="500">{{ old('remarks', $guide->remarks) }}</textarea>
                                @error('remarks')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="d-flex justify-content-between mt-4">
                            ...
                            <div>
                                <a href="{{ route('masters.guides.show', $guide) }}" class="btn btn-info">
