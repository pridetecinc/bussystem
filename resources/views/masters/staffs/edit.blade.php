        ...
        <div class="col-md-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">スタッフ編集</li>
                </ol>
            </nav>
            ...
            <div class="card shadow-sm">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0">
                        <i class="bi bi-person-gear"></i> スタッフ編集
                    </h5>
                </div>
                
                <div class="card-body">
                    <form action="{{ route('masters.staffs.update', $staff) }}" method="POST" id="staffForm">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('staff_code') is-invalid @enderror" 
                                       id="staff_code" name="staff_code" 
                                       value="{{ old('staff_code', $staff->staff_code) }}" 
                                       required maxlength="20" placeholder="例: ST001">
                                @error('staff_code')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control @error('display_order') is-invalid @enderror" 
                                       ...
                                       value="{{ old('display_order', $staff->display_order) }}" 
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('login_id') is-invalid @enderror" 
                                       ...
                                       value="{{ old('login_id', $staff->login_id) }}" 
                                       required maxlength="50" placeholder="例: yamada">
                                @error('login_id')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('role') is-invalid @enderror" 
                                    ...
                                    <option value="">選択してください</option>
                                    <option value="admin" {{ old('role', $staff->role) == 'admin' ? 'selected' : '' }}>管理者</option>
                                    <option value="operations_manager" {{ old('role', $staff->role) == 'operations_manager' ? 'selected' : '' }}>運行管理者</option>
                                    <option value="coordinator" {{ old('role', $staff->role) == 'coordinator' ? 'selected' : '' }}>運行手配</option>
                                    <option value="manager" {{ old('role', $staff->role) == 'manager' ? 'selected' : '' }}>経理</option>
                                    <option value="driver" {{ old('role', $staff->role) == 'driver' ? 'selected' : '' }}>運転手</option>
                        ...
                        <div class="d-flex justify-content-between mt-4">
                            ...
                            <div>
                                <a href="{{ route('masters.staffs.show', $staff) }}" class="btn btn-info">
