        ...
        <div class="col-md-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">料金編集</li>
                </ol>
            </nav>
            ...
            <div class="card shadow-sm">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0">
                        <i class="bi bi-cash-gear"></i> 料金編集
                    </h5>
                </div>
                
                <div class="card-body">
                    <form action="{{ route('masters.fees.update', $fee) }}" method="POST" id="feeForm">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('fee_code') is-invalid @enderror" 
                                       id="fee_code" name="fee_code" 
                                       value="{{ old('fee_code', $fee->fee_code) }}" 
                                       required maxlength="20" placeholder="例: FEE001">
                                @error('fee_code')
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('fee_name') is-invalid @enderror" 
                                       id="fee_name" name="fee_name" 
                                       value="{{ old('fee_name', $fee->fee_name) }}" 
                                       required maxlength="100" placeholder="例: 基本料金">
                                @error('fee_name')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('fee_category') is-invalid @enderror" 
                                       id="fee_category" name="fee_category" 
                                       value="{{ old('fee_category', $fee->fee_category) }}" 
                                       required maxlength="50" placeholder="例: 基本料金">
                                @error('fee_category')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control @error('display_order') is-invalid @enderror" 
                                       ...
                                       value="{{ old('display_order', $fee->display_order) }}" 
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control @error('tax_rate') is-invalid @enderror" 
                                       ...
                                       value="{{ old('tax_rate', $fee->tax_rate) }}" 
                                       required min="0" max="100" step="0.1" placeholder="例: 10.0">
                                @error('tax_rate')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control @error('default_amount') is-invalid @enderror" 
                                       ...
                                       required min="0" step="1" placeholder="例: 10000">
                        ...
                        <div class="d-flex justify-content-between mt-4">
                            ...
                            <div>
                                <a href="{{ route('masters.fees.show', $fee) }}" class="btn btn-info">
