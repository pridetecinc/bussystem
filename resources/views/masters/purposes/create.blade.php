        ...
        <div class="col-md-12">
            ...
            <div class="card shadow-sm">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0">
                        <i class="bi bi-tag"></i> 新規目的登録
                    </h5>
                </div>
                
                <div class="card-body">
                    <form action="{{ route('masters.purposes.store') }}" method="POST" id="purposeForm">
                        @csrf
                        ...
                        <div class="mb-3">
                            <div class="form-check">
                                ...
                                @error('is_active')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <small class="form-text text-muted">チェックを外すと無効状態で登録されます</small>
                            </div>
                        </div>
