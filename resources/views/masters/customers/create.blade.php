        ...
        <div class="col-md-12">
            ...
            <div class="card shadow-sm">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0">
                        <i class="bi bi-person-add"></i> 新規顧客登録
                    </h5>
                </div>
                
                <div class="card-body">
                    <form action="{{ route('masters.customers.store') }}" method="POST" id="customerForm">
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('address') is-invalid @enderror" 
                                      ...
                                      maxlength="200" placeholder="例: 東京都千代田区丸の内1-2-3 東京ビル5F">{{ old('address') }}</textarea>
                            @error('address')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('remarks') is-invalid @enderror" 
                                      ...
                                      maxlength="500" placeholder="例: 特記事項、取引条件など">{{ old('remarks') }}</textarea>
                            @error('remarks')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
