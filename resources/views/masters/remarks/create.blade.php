        ...
        <div class="col-md-12">
            ...
            <div class="card shadow-sm">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0">
                        <i class="bi bi-chat-square-text-plus"></i> 新規備考登録
                    </h5>
                </div>
                
                <div class="card-body">
                    <form action="{{ route('masters.remarks.store') }}" method="POST" id="remarkForm">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('remark_code') is-invalid @enderror" id="remark_code" name="remark_code" value="{{ old('remark_code') }}" required maxlength="20" placeholder="例: REM001">
                                @error('remark_code')
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('title') is-invalid @enderror" id="title" name="title" value="{{ old('title') }}" required maxlength="100" placeholder="例: 注意事項">
                                @error('title')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('category') is-invalid @enderror" id="category" name="category" value="{{ old('category') }}" required maxlength="50" placeholder="例: 一般">
                                @error('category')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="mb-3">
                            <textarea class="form-control @error('content') is-invalid @enderror" id="content" name="content" rows="5" maxlength="2000" placeholder="備考の内容を入力してください（2000文字以内）">{{ old('content') }}</textarea>
                            @error('content')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
