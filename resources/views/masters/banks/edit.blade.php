    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    <form action="{{ route('masters.banks.update', $bank) }}" method="POST" id="bankForm">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control @error('display_order') is-invalid @enderror" 
                                       ...
                                       value="{{ old('display_order', $bank->display_order) }}"
                                       min="0" step="1">
                                @error('display_order')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-control @error('is_active') is-invalid @enderror" 
                                    ...
                                    <option value="1" {{ old('is_active', $bank->is_active) == '1' ? 'selected' : '' }}>有効</option>
                                    <option value="0" {{ old('is_active', $bank->is_active) == '0' ? 'selected' : '' }}>無効</option>
                                </select>
                                @error('is_active')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <textarea class="form-control @error('remarks') is-invalid @enderror" 
                                          ...
                                          placeholder="例: 給与振込専用口座">{{ old('remarks', $bank->remarks) }}</textarea>
                                @error('remarks')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="d-flex justify-content-between mt-4">
                            ...
                            <div>
                                <a href="{{ route('masters.banks.show', $bank) }}" class="btn btn-info">
