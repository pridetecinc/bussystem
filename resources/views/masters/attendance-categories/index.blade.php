    ...
    <div class="row">
        <div class="col-md-12">
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <a href="{{ route('masters.attendance-categories.create') }}" class="btn btn-primary"><i class="bi bi-plus-lg"></i> 新規追加</a>
            </div>
            ...
            <div class="mb-3">
                <div class="card-body">
                    <form method="GET" action="{{ route('masters.attendance-categories.index') }}" class="row g-2">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-auto">
                            ...
                            @if(request('search'))
                                <a href="{{ route('masters.attendance-categories.index') }}" class="btn btn-outline-secondary">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered mb-0 table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><code>{{ $category->attendance_code }}</code></td>
                                <td>{{ $category->attendance_name }}</td>
                                <td>
                                ...
                                <td>
                                    <div class="d-flex gap-1">
                                        <a href="{{ route('masters.attendance-categories.show', $category) }}" 
                                           class="btn btn-sm btn-outline-info" title="詳細">
                                            <i class="bi bi-eye"></i>
                                        </a>
                                        <a href="{{ route('masters.attendance-categories.edit', $category) }}" 
                                        ...
                                        <form action="{{ route('masters.attendance-categories.destroy', $category) }}" method="POST" 
                                              class="d-inline" 
                                              onsubmit="return confirmDelete('{{ $category->attendance_name }}')">
                                            @csrf
                                            @method('DELETE')
