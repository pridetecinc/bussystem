    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    <form action="{{ route('masters.attendance-categories.update', $attendanceCategory) }}" method="POST" id="categoryForm">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('attendance_code') is-invalid @enderror" 
                                       ...
                                       value="{{ old('attendance_code', $attendanceCategory->attendance_code) }}" 
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('attendance_name') is-invalid @enderror" 
                                       ...
                                       value="{{ old('attendance_name', $attendanceCategory->attendance_name) }}" 
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    <input type="color" class="form-control form-control-color @error('color_code') is-invalid @enderror" 
                                           id="color_picker" value="{{ old('color_code', $attendanceCategory->color_code) }}" title="カラーを選択">
                                    <input type="text" class="form-control @error('color_code') is-invalid @enderror" 
                                           id="color_code" name="color_code" 
                                           value="{{ old('color_code', $attendanceCategory->color_code) }}" 
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control @error('display_order') is-invalid @enderror" 
                                       ...
                                       value="{{ old('display_order', $attendanceCategory->display_order) }}" 
                        ...
                        <div class="d-flex justify-content-between mt-4">
                            ...
                            <div>
                                <a href="{{ route('masters.attendance-categories.show', $attendanceCategory) }}" class="btn btn-info">
