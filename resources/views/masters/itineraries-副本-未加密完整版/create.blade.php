    ...
    if (itineraryForm) {
        itineraryForm.addEventListener('submit', function(e) {
            ...
            rows.forEach((row) => {
                ...
                const hasData = (arrivalInput && arrivalInput.value.trim()) ||
                               (departureInput && departureInput.value.trim()) ||
                               (descriptionInput && descriptionInput.value.trim()) ||
                               (row.querySelector('.remark') && row.querySelector('.remark').value.trim());
                
                if (hasData && descriptionInput && !descriptionInput.value.trim()) {
