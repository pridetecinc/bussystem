        ...
        <div class="col-md-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">ドライバー編集</li>
                </ol>
            </nav>
            ...
            <div class="card shadow-sm">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0">
                        <i class="bi bi-person-badge"></i> ドライバー編集
                    </h5>
                </div>
                
                <div class="card-body">
                    <form method="POST" action="{{ route('masters.drivers.update', $driver) }}" id="driverForm">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="date" class="form-control @error('hire_date') is-invalid @enderror" 
                                       ...
                                       value="{{ old('hire_date', \Carbon\Carbon::parse($driver->hire_date)->format('Y-m-d')) }}" required>
                                @error('hire_date')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="date" class="form-control @error('license_expiration_date') is-invalid @enderror" 
                                       ...
                                       value="{{ old('license_expiration_date', \Carbon\Carbon::parse($driver->license_expiration_date)->format('Y-m-d')) }}" required>
